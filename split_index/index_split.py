...
def main():
   ...
   shell_info = "/lustre1/chengqiyi_pkuhpc/cxzhu/01.SJH/0626/20160625/index_split/split_index/index_split -t %d -l %d -b %d %s %s %s" % ( phreads,read_leng,barcode_error,  infile_1,infile_2,bar_seq )
